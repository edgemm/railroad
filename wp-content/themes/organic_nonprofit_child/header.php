...
<link rel="Shortcut Icon" href="/wp-content/themes/organic_nonprofit_child/images/favicon.ico" type="image/x-icon">
		...
		<div class="row">
			...
			<?php if (is_home() || is_front_page() ) { ?>
				<?php $header_image = get_header_image(); if ( ! empty( $header_image ) ) { ?>
					<div id="custom-header"><a href="<?php echo get_option('home'); ?>/" title="Home"><img src="<?php header_image(); ?>" height="<?php echo get_custom_header()->height; ?>" width="<?php echo get_custom_header()->width; ?>" alt="<?php bloginfo('name'); ?>" /><?php bloginfo( 'name' ); ?></a></div>
			...
			<div class="three columns">
			    ...
			    <div class="header-search">
			        <div id="phone">
                       ...
                       <h3>Call Now <a href="tel:+18008681816">800.868.1816</a></h3>
