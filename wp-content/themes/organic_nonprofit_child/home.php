...
<div class="container home">
    ...
    <div id="homeclip">
	<div class="postapplynowhome">
	       <h1>A Rewarding Career in Just 6 Months</h1> 
	       <p>Prepare for an Exciting Career in the Railroad Industry with the NW-RI Rail Operations Training Program!</p>
	       <a href="/apply-now/"><strong>Apply Now!</strong></a>
	</div>
	<div class="postpromovideo">
		<iframe width="470" height="264" src="//www.youtube.com/embed/rtjIkFYXCQM?rel=0" frameborder="0" allowfullscreen></iframe>
	</div>
    </div>
	        ...
	        <div class="six columns">
		        ...
		        <div class="organic-tabs">
		            ...
		            <div id="tabs-<?php echo $count; ?>">
	                    ...
	                    <a class="organic-btn " href="<?php the_permalink(); ?>" rel="bookmark"><span class="btn-holder"><?php _e("Learn More", 'organicthemes'); ?></span></a>
		             </div>
