		...
		<div class="eight columns">
			...
			<div <?php post_class('postarea padded'); ?> id="post-<?php the_ID(); ?>">
	            	...
	            	<div class="archive-holder">
			            ...
			            <?php else: ?>
			            	<?php if ( has_post_thumbnail()) { ?>
			                	<a class="feature-img" href="<?php the_permalink(); ?>" rel="bookmark"><?php the_post_thumbnail( 'featured-large' ); ?></a>
			                <?php } ?>
			            <?php endif; ?>
				...
				<?php endwhile; else: ?> 
		            ...
		            <p><?php _e("We're sorry, but no posts have been found.", 'organicthemes'); ?></p>
	            </div>
				<?php endif; ?>
